...
export declare const TimingCategories: {
    readonly REPLInstantiation: "REPLInstantiation";
    readonly UserConfigLoading: "UserConfigLoading";
    readonly DriverSetup: "DriverSetup";
    readonly Logging: "Logging";
    readonly SnippetLoading: "SnippetLoading";
    readonly Snapshot: "Snapshot";
    readonly ResourceFileLoading: "ResourceFileLoading";
    readonly AsyncRewrite: "AsyncRewrite";
    readonly Eval: "Eval";
    readonly EvalFile: "EvalFile";
    readonly Telemetry: "Telemetry";
    readonly Main: "Main";
};
export type TimingCategory = (typeof TimingCategories)[keyof typeof TimingCategories];
